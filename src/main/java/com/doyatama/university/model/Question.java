...
public class Question {
    ...
    public Question(String idQuestion, String title, String description, QuestionType questionType, AnswerType answerType, String file_path, RPS rps, RPSDetail rps_detail_id, ExamType examType, ExamType2 examType2, ExamType3 examType3, String explanation, List<CriteriaValue> criteria_values, Double averageValue1, Double averageValue2, Double averageValue3, Double averageValue4, Double averageValue5, Double averageValue6, Double averageValue7, Double averageValue8, Double averageValue9, Double averageValue10) {
    ...
    public RPSDetail getRps_detail_id() {
        return rps_detail_id;
    }

    public void setRps_detail_id(RPSDetail rps_detail_id) {
        this.rps_detail_id = rps_detail_id;
    }
